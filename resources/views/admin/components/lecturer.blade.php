    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">List Lecturer</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a type="button" href="{{ route('lecturer.create') }}" class="btn btn-md btn-primary">Add
                            Lecturer</a>
                    </div>
                </div>
                <br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='btn-group-vertical'>
                                                        <a type='button'
                                                            href="{{ route('lecturer.edit', ['id' => $s->id]) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer text-right">
                                                            <form action="{{ route('lecturer.delete', ['id' => $s->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
